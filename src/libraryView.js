...
const labels = {
  ...
  character: "Pre-gen heroes", reference: "Reference"
};

const icons = {
  room: "⌂", npc: "♟", monster: "☠", trap: "⚠", treasure: "◆",
  clue: "⌕", event: "✦", character: "♞", reference: "?"
};
...
export const libraryView = (query = "", kind = "all") => {
  ...
  return `<main class="catalog-page">
    ...
    <section class="catalog-hero"><small>SEARCH THE COLLECTION</small><h1>Every card. One growing library.</h1>
      <p>Browse verified cards by the exact role they play on the table. Duplicate IDs and duplicate content are rejected before release.</p>
