...
export const systemGuideView = system => pageShell(`
  <article class="system-guide">
    ...
    <nav class="guide-tabs" aria-label="Guide sections"><a href="#player-guide">Player fundamentals</a><a href="#gm-guide">So you want to GM?</a><a href="#license-guide">Licensing</a></nav>
